 ...
 * and Privacy Policy AND authorizes the contact required to confirm, verify, and
 * activate the order — specifically a confirmation call from an advisor at the
 * time window the customer selected at checkout. It is NOT a marketing opt-in,
 * which is why it can gate the purchase.
 *
...
export const CONSENT_COPY = {
  ...
  after:
    ", and I authorize Mahalo Enterprise and its authorized partners to contact me — including a confirmation call at the time I selected — by phone, text message, prerecorded message, and email, including with automated technology, at the number and email I provided, in order to confirm, verify, and activate this order. Checking this box constitutes my electronic signature.",
} as const;
