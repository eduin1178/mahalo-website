...
Defines the public checkout wizard experience: a four-phase flow (Plan, Customize, Details, Installation) that lets a prospective customer choose a plan, customize it with add-ons (auto-skipped when none exist), provide contact/address/payment information, and schedule installation, with an order total panel shown on every phase except Plan, guarded navigation, legacy URL redirects, and English (US market) copy.
## Requirements
