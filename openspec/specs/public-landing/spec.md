...
Public-facing landing page (`/`) that markets Mahalo's internet-comparator service to anonymous US visitors and funnels them into the address-based search flow. Covers visual hierarchy, content sections, trust signals, price anchoring, and mobile conversion patterns.
